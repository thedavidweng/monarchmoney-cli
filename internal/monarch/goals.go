...
var (
	GetGoalsQuery                = queries.Get("goals/list.graphql")
	GetSavingsGoalBudgetsQuery   = queries.Get("goals/budgets.graphql")
	GetGoalQuery                 = queries.Get("goals/show.graphql")
	CreateGoalMutation           = queries.Get("goals/create.graphql")
	UpdateGoalMutation           = queries.Get("goals/update.graphql")
	DeleteGoalMutation           = queries.Get("goals/delete.graphql")
	ArchiveGoalMutation          = queries.Get("goals/archive.graphql")
	UnarchiveGoalMutation        = queries.Get("goals/unarchive.graphql")
	UpdateGoalPrioritiesMutation = queries.Get("goals/priorities.graphql")
	LinkGoalAccountMutation      = queries.Get("goals/link_account.graphql")
	ListGoalEventsQuery          = queries.Get("goals/events.graphql")
	ContributeToGoalMutation     = queries.Get("goals/contribute.graphql")
	WithdrawFromGoalMutation     = queries.Get("goals/withdraw.graphql")
	UpdateGoalEventMutation      = queries.Get("goals/event_update.graphql")
	DeleteGoalEventMutation      = queries.Get("goals/event_delete.graphql")
	GetGoalBudgetAmountsQuery    = queries.Get("goals/budget_amounts.graphql")
	SetGoalBudgetAmountMutation  = queries.Get("goals/budget_amount_set.graphql")
	GetGoalContributionsQuery    = queries.Get("goals/contributions.graphql")
)
